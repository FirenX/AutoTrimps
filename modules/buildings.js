...
function buyBuildings() {
    ...
    if ((targetBreed < getBreedTime() || targetBreed <= 0 ||
            ...
            (!game.jobs.Geneticist.locked && canAffordJob('Geneticist', false, 1)) && !enoughHealth && (new Date().getTime() - game.global.zoneStarted > 60*1000)) && !game.buildings.Nursery.locked) {
