...
// Scryer settings
    ...
    createSetting('ScryerUseWhenPoison', 'Use When Poison', 'Use when we have the Poison Empowerment. Exclusively overrides Corrupted and Empowered Setting.', 'boolean', true, null, 'Scryer');
